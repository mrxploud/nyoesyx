...
- **`docs/`**: Especificações da linguagem, arquitetura da VM, manifesto do protocolo DTP, o [Manifesto Técnico Completo](docs/MANIFESTO_TECNICO.md) e o [FAQ & Defesa da Arquitetura](docs/FAQ_ARQUITETURA.md).
